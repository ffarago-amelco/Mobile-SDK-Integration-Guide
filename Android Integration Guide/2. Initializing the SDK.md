...
## 10. Optional: ProGuard support only

The Optimove SDK currently doesn't support **ProGuard**. If your app uses **ProGuard** for code obfuscation please add an exclusion rule for the Optimove SDK in your `proguard.config` file:
```
